...
# ZIP labels: subtle but readable at a glance.
MAP_ZIP_LABEL_TEXT = [66, 68, 72, 240]
MAP_ZIP_LABEL_INTERSECT = [171, 73, 32, 255]
MAP_ZIP_LABEL_HALO = [255, 255, 255, 245]
MAP_ZIP_LABEL_SIZE = 11
MAP_ZIP_LABEL_INTERSECT_SIZE = 12
